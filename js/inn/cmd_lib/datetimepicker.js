define(function(require, exports, module) {
    require('plugin/datetimepicker/jquery.datetimepicker.css');
});
/**
        ...
        var KEY0 = 48,
            ...
            createDateTimePicker = function( input ) {
                ...
                datetimepicker.setOptions = function( _options ) {
                    ...
                    mounth_picker
                        .find('.xdsoft_set_today')
                        .css('display',options.setToday?'block':'none');
                ...
                mounth_picker.find('.xdsoft_set_today').on('click', function() {
                    input.val('至今');
                    datetimepicker.trigger('close.xdsoft');
                });
                mounth_picker
